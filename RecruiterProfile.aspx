...
<div class="form-group row">
                                <label for="comapny_name" class="col-md-4 col-form-label text-md-right">Company Name</label>
                                <div class="col-md-6">
                                    <asp:TextBox ID="txtCompanyNm" runat="server" class="form-control form-control-user " required="" autofocus=""></asp:TextBox>
<asp:RegularExpressionValidator ID="RegularExpressionValidator1" runat="server" ErrorMessage="Please Enter Valid Company Name" ControlToValidate="txtCompanyNm" ForeColor="Red" ValidationExpression="^(?=.*[A-Za-z])(?=.*\d)(?=.*[$@$!%*#?&amp;])[A-Za-z\d$@$!%*#?&amp;]{20,35}$"></asp:RegularExpressionValidator>
                                </div>
...
<asp:RegularExpressionValidator ID="RegularExpressionValidator2" runat="server" ErrorMessage="Please Enter Valid Company Name" ControlToValidate="txtWorking" ForeColor="Red" ValidationExpression="^(?=.*[A-Za-z])(?=.*\d)(?=.*[$@$!%*#?&amp;])[A-Za-z\d$@$!%*#?&amp;]{20,35}$"></asp:RegularExpressionValidator>
</div>
                            </div>
