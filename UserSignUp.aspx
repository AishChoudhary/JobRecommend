                    ...
                    <div class="card-body">
                        <form id="form1" runat="server">
                             ...
                             <div class="form-group row">
                                <label for="email_address" class="col-md-4 col-form-label text-md-right">Full Name<asp:Label ID="Label1" runat="server" ForeColor="Red" Text="*"></asp:Label>
                                 </label>
                                &nbsp;<div class="col-md-6">
                                 ...
                                 E-Mail Address<asp:Label ID="Label2" runat="server" ForeColor="Red" Text="*"></asp:Label>
                                 </label>
                                 &nbsp;<div class="col-md-6">
