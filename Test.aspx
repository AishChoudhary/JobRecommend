<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Test.aspx.cs" Inherits="JobRecommend.Test" %>
      ...
      <div id="content">
        ...
        <!-- Begin Page Content -->
          ...
          <div class="header-middle">
              <div class="card border-center-info ">
                <div class="card-body">
...
<div class="form-group row" >
    ...
    <div class="container"><asp:RadioButton ID="rdOption1" Text="Answer1" runat="server" GroupName="answer" /> </div>
                                        <div class="container"><asp:RadioButton ID="rdOption2" Text="Answer2" runat="server" GroupName="answer"/></div>
                                       <div class="container"><asp:RadioButton ID="rdOption3" Text="Answer3" runat="server" GroupName="answer" /></div>
                                        <div class="container"><asp:RadioButton ID="rdOption4" Text="Answer4"  runat="server" GroupName="answer" OnCheckedChanged="rdOption4_CheckedChanged" /></div>
